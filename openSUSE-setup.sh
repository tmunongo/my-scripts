...
sudo zypper install -y chromium flameshot vivaldi flameshot-fish-completion flameshot-zsh-completion intellij android-studio
# VS Code
...
# Install software
sudo flatpak install -y flathub com.spotify.Client md.obsidian.Obsidian Postman Jetbrains.IntelliJ-IDEA-Community
